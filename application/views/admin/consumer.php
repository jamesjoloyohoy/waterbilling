				...
				<div class="pd-20 bg-white border-radius-4 box-shadow">
					...
					<div class="tab">
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="connect" role="tabpanel">
								<div class="pd-20">
									...
									<form class="row" action = "<?php echo base_url('admin/zone');?>" method = "POST">
										<div class="col-md-3 col-sm-12">
											<div class="form-group">
												<label>Zone</label>
												<br />
												<input type = "search" list = "zone" name = "searchZone" class="form-control-sm" placeholder = "Search...">
												<datalist id = "zone">
													<option></option>
										...
										<div class="col-md-3 col-sm-12">
											<div class="form-group">
												...
												<input type = "search" list = "barangay" name = "searchBrgy" class="form-control-sm" placeholder = "Search...">
														...
														<td class = "text-center">
															<div class="dropdown">
																...
																<div class="dropdown-menu">
																	...
																	<br />
																	<button onclick = "update_consumer('<?php echo $c->Cons_no?>','<?php echo $c->Cons_fName?>','<?php echo $c->Cons_mName?>','<?php echo $c->Cons_faName?>','<?php echo $c->Cons_zone?>','<?php echo $c->Cons_barangay?>','<?php echo $c->Cons_spouse?>','<?php echo $c->Cons_dApplied?>','<?php echo $c->Cons_status?>','<?php echo $c->Cons_serviceFee?>','<?php echo $c->Cons_otherFee?>','<?php echo $c->fee_Fee_no?>')" class = "btn btn-secondary btn-sm" type="button" data-toggle="modal"  style = "margin-left: 15%;">
																		<i class="fa fa-pencil"></i> Update
																	</button>
																	<br />
																	<a class = "btn btn-danger btn-sm" style = "margin-left: 15%; margin-top: 3%;" type = "button" href="<?php echo base_url('admin/consumer/disconnect/'.$c->Mtr_no); ?>">
																		<i class = "fa fa-times"> Disconnect</i>
																	</a>
																	<br />
																	<br />
																</div> 
															...
															<div class="dropdown">
																...
																<div class="dropdown-menu">
																	...
																	<button class = "btn btn-primary btn-sm"  style = "margin-left: 15%;">
																		<a href = "<?php echo base_url('admin/consumer/get_consumerInfo/'.$cd->Mtr_no);?>">
																			<i class = "fa fa-eye" style = "color: white"> View</i>
																		</a>
																	</button>
																	<br />
																	<a class = "btn btn-secondary btn-sm"  style = "margin-left: 15%; margin-top: 3%;" type = "button" href="<?php echo base_url('admin/consumer/connect/'.$cd->Mtr_no); ?>">
																		<i class = "fa fa-pencil"> Reconnect</i>
																	</a>
																	<br />
																	<br />
																</div> 
