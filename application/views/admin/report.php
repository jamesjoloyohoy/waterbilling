					...
					<div class="tab">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="paid" role="tabpanel">
								<div class="pd-20">
                                <form action="<?php echo base_url('admin/paidByDate/');?>">
                                ...
                                <form action="<?php echo base_url('admin/paid/getConsumerRecord');?>" method = "POST">
                                ...
                                <table class="data-table table-bordered stripe hover nowrap" style = "margin-left: -3%;">
                                    <thead>
                                        <tr>
                                            <th class="table-plus datatable-nosort">No.</th>
                                            <th>Date</th>
