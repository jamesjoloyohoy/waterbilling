<div class="modal fade" id="resetEmp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"  style = "margin-top: -1%;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id = "resetEmployee" method = "POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <input class="form-control" type="text" readonly = "" id = "fNames" name = "ufName" style = "background-color: white;" autocomplete = "off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-4 col-form-label">M.I</label>
                            <div class="col-sm-12 col-md-8">
                                <input class="form-control" type="text" readonly = "" id = "mNames" name = "umName" style = "background-color: white;" autocomplete = "off">
                            </div>
                        </div>
                        <div class="form-group row">
